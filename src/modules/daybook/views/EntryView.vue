<template>
  ...
  <div class="d-flex flex-column px-3 h-75">
    <textarea placeholder="Que pasa hoy?"></textarea>
  </div>
  <fab-button icon="fa-save"></fab-button>

  <img
    src="https://www.pcgamesn.com/wp-content/uploads/2022/01/elden-ring-like-dnd-adventure-1.jpg"
